...
public class TP02Q05 {
    ...
    public static int selectionSort(Pokemons[] array, int cont) {
        int n = cont;
        int comp = 0;
        for (int i = 0; i < n - 1; i++) {
            int minIndex = i;
    ...
    public static void main(String[] args) {
        ...
        int numComparacao = selectionSort(arrayOrdenado, cont);
